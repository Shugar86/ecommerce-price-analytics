...
### Added
- `README.md` — vibe-first описание продукта, стек, быстрый старт, источники данных.
- `AGENTS.md` — контракт для AI-агентов: режим, стек, DoD, escalation.
- `LICENSE` — MIT.
- `CONTRIBUTING.md` — правила участия, стиль кода, DoD для PR.
- `CHANGELOG.md` — базовая структура и история изменений.

### Changed
- Уточнена терминология сопоставления: exact-ключи + fuzzy-кандидаты + ручной ревью.
